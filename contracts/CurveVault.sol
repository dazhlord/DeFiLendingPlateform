...
contract CurveVault is IVault, Ownable {
    ...
    address public immutable cvxStaker;
    ...
    constructor(address _LP, address _sToken, address _oracle, address _cvxStaker) {
        LP = _LP;
        sToken = _sToken;
        oracle = _oracle;

        cvxStaker = _cvxStaker;
    }
    ...
    function deposit(uint256 amount) external {
        ...
        ICvxStaker(cvxStaker).deposit(7 days, amount, false);
